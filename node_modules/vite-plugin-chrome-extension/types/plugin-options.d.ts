...
export declare type ChromeExtensionPlugin = Pick<Required<Plugin>, "name" | "configResolved" | "buildStart" | "resolveId" | "load" | "watchChange" | "outputOptions" | ManifestInputPluginHooks | HtmlInputsPluginHooks> & {
    _plugins: {
...
declare type ManifestInputPluginHooks = "options" | "generateBundle";
...
declare type HtmlInputsPluginHooks = "name" | "generateBundle";
